insert into app_user(id,name,username,password) values (1,'Samraj Timmapuram','admin','admin');
insert into app_user(id,name,username,password) values (2,'Sudhakar KR','user','user');
